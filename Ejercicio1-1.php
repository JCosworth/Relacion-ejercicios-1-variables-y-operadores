<?php
echo "<b>Ejercicio 1:</b> Define una constante con el valor de la gravedad terrestre (9.8). <br />";
echo "Luego, crea una variable que almacene la masa de un objeto y calcula su peso <br />";
echo "multiplicando la masa por la constante de gravedad. Muestra el resultado. <br />";
echo "<br />";
